      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <?php $abc=$_GET['id'];
           // $aa=$_GET['id2'];
            ?>
            <h5 class="card-title"><?php echo $abc; ?></h5>
            <p class="card-text"> Submit your best <?php echo $abc; ?> recipe and win a chance to have it featured on our menu!</p>
            <form>
